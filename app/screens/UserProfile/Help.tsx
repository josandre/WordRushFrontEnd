        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
                style={[style.r14, { color: Colors.disable, marginTop: 3 }]}
              >
                Updated • 1 month ago
              </Text>
              <Text style={[style.r16, { color: Colors.txt1, marginTop: 5 }]}>
                Queezy apps offer gamified quizzes with many different topics to
                test out your knowledge.
              </Text>
              <Text style={[style.r16, { color: Colors.txt1, marginTop: 8 }]}>
                With Queezy you can also take part in challenges with friends or
                against others.
              </Text>
              <Image
