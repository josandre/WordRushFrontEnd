      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <View
                style={[style.inputcontainer, { backgroundColor: Colors.bord }]}
              >
              ...
              <Text
                style={[style.m14, { color: Colors.disable, marginTop: 20 }]}
              >
                INTRO
              </Text>
              <View
                style={[
                  style.divider,
                  { backgroundColor: Colors.bord, marginVertical: 12 },
                ]}
              ></View>
              ...
              <Text
                style={[style.m14, { color: Colors.disable, marginTop: 25 }]}
              >
