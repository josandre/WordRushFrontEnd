import { View, Dimensions, StatusBar, KeyboardAvoidingView, ImageBackground, Platform } from 'react-native'
                ...
                <KeyboardAvoidingView style={optionStyles.keyboardAvoiding} behavior={keyboardBehavior()}>
                    <View style={optionStyles.contentWrapper}>
                        <OptionCard
                            ...
                            onLogin={() => navigation.navigate('Login', { fromRegisterSuccess: false })}
