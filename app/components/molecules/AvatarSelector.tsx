...
export default function AvatarSelector({ selectedAvatar, onAvatarSelect, label = 'Choose Avatar' }: AvatarSelectorProps) {
    const [selected, setSelected] = useState<string>(selectedAvatar || AVAILABLE_AVATARS[0])
    ...
    return (
        <View style={styles.avatarSelectorContainer}>
            ...
            <FlatList
                ...
                contentContainerStyle={[styles.avatarListContainer, styles.webAvatarListContainer]}
